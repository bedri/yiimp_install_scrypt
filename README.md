# Yiimp_install_scrypt v0.3 (update September, 2020) - A fork from [https://github.com/xavatar/yiimp_install_scrypt](https://github.com/xavatar/yiimp_install_scrypt)
...
## Install script for yiimp on Ubuntu Server 18.04 (using Bedri's Yiimp for X11K)
...
- Are you using a subdomain (anser yes if you are using a domainname like mypoolx11k.example.com)
- Enter support email
